...
@section('content')
{!! Form::model($championship, ['route' => ['championships.update', $championship->id], 'method' => 'put', 'class'=>'', 'role' => 'form']) !!}
<div class="mdl-grid ">
	...
	<div class="mdl-cell mdl-cell--4-col-tablet mdl-cell--12-col-desktop">
		{!! Form::submit(__('championships.form.save'), ['class' => 'mdl-button mdl-js-button mdl-js-ripple-effect mdl-color--primary mdl-color-text--white mdl-button--raised']); !!}
	</div>
</div>
{!! Form::close() !!}
@endsection